...
class SimpleProblemSolvingAgent(Agent):
    ...
    def _cheat_code(self):
        """Cheat code
        """
        self.successors[2*nrows+1][3] = (100, 1*nrows+1)
        self.successors[1*nrows+0][2] = (100, 1*nrows+1)
        self.successors[0*nrows+1][1] = (100, 1*nrows+1)
        self.successors[1*nrows+2][0] = (100, 1*nrows+1)
        self.successors[1*nrows+2][2] = (100, 1*nrows+3)
        self.successors[0*nrows+3][1] = (100, 1*nrows+3)
        self.successors[2*nrows+2][2] = (100, 2*nrows+3)
        self.successors[2*nrows+0][1] = (100, 3*nrows+0)
        self.successors[3*nrows+1][0] = (100, 3*nrows+0)

    def _wall(self):
        self.successors[0][3] = (50, 0)
        self.successors[1][3] = (50, 1)
        self.successors[2][3] = (50, 2)
        self.successors[3][3] = (50, 3)
        self.successors[3][2] = (50, 3)
        self.successors[7][2] = (50, 7)
        self.successors[11][2] = (50, 11)
        self.successors[15][2] = (50, 15)
        self.successors[12][1] = (50, 12)
        self.successors[13][1] = (50, 13)
        self.successors[14][1] = (50, 14)
        self.successors[15][1] = (50, 15)
        self.successors[0][0] = (50, 0)
        self.successors[4][0] = (50, 4)
        self.successors[8][0] = (50, 8)
        self.successors[12][0] = (50, 12)
